...
const builtIn = { user: ['queues:read'], admin: ['*'], owner: ['*'], super_admin: ['*'], organization_admin: ['organizations:read', 'organizations:write', 'queues:read', 'queues:write'], venue_manager: ['queues:read', 'queues:write'], counter_operator: ['queues:read'] };
